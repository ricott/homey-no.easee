...
//offlineChargingMode, finns enum

//This is the current set on each charger. Will be reset after plugging in a car or rebooting the charger.
...
EaseeCharger.prototype.getChargers = function () {
    return getCommand(this.options, '/api/chargers')
