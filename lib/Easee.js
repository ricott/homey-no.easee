...
class Easee {
    ...
    #postWaitForResponse = function (url, payload) {
        ...
        let self = this;
        return invoke('post', self, url, payload)
    ...
    */
    ...
    setChargingPrice = function (siteId, currency, costPerKWh, taxPerKWh) {
        ...
        return invoke('post', this, `/api/sites/${siteId}/price`, data)
            .then(function (result) {
                return result;
            })
            .catch(reason => {
    ...
    deleteBasicChargePlan = function (chargerId) {
        return invoke('delete', this, `/api/chargers/${chargerId}/basic_charge_plan`)
            .then(function (result) {
                return result;
            })
            .catch(reason => {
    ...
    getDynamicCircuitCurrent = function (siteId, circuitId) {
        ...
        return invoke('get', this, `/api/sites/${siteId}/circuits/${circuitId}/dynamicCurrent`)
    ...
    getBasicChargePlan = function (chargerId) {
        return invoke('get', this, `/api/chargers/${chargerId}/basic_charge_plan`)
    ...
    getChargerConfig = function (chargerId) {
        return invoke('get', this, `/api/chargers/${chargerId}/config`)
    ...
    getChargerDetails = function (chargerId) {
        return invoke('get', this, `/api/chargers/${chargerId}/details`)
    ...
    getChargerState = function (chargerId) {
        return invoke('get', this, `/api/chargers/${chargerId}/state`)
            .then(function (state) {
                return state;
            })
            .catch(reason => {
    ...
    getSiteInfo = function (chargerId) {
        return invoke('get', this, `/api/chargers/${chargerId}/site`)
            .then(function (site) {
                return site;
            })
            .catch(reason => {
    ...
    getChargers = function () {
        return invoke('get', this, '/api/accounts/products')
    ...
    getEqualizerSiteInfo = function (equalizerId) {
        return invoke('get', this, `/api/equalizers/${equalizerId}/site`)
            .then(function (site) {
                return site;
            })
            .catch(reason => {
    ...
    getEqualizerState = function (equalizerId) {
        return invoke('get', this, `/api/equalizers/${equalizerId}/state`)
            .then(function (state) {
                return state;
            })
            .catch(reason => {
    ...
    getEqualizerConfig = function (equalizerId) {
        return invoke('get', this, `/api/equalizers/${equalizerId}/config`)
            .then(function (state) {
                return state;
            })
            .catch(reason => {
    ...
    getLast30DaysChargekWh = function (chargerId) {
        ...
        return invoke('get', this, `/api/sessions/charger/${chargerId}/total/${fromDateString}/${toDateString}`)
            .then(function (stats) {
                if (!isNaN(stats)) {
    ...
    getLastChargeSessionkWh = function (chargerId) {
        ...
        return invoke('get', this, `/api/sessions/charger/${chargerId}/sessions/${fromDateString}/${toDateString}`)
...
async function invoke(method, self, path, data) {
...
function getCommandStatus(self, data) {
    return invoke('get', self, `/api/commands/${data.device}/${data.commandId}/${data.ticks}`)
        .then(function (response) {
    ...
    while (!done && counter < maxRetries) {
        ...
        await func()
            ...
            .catch(reason => {
                ...
                if (reason.message.indexOf('404') > -1) {
                    console.log(`Got a 404 error from commands API, attempt ${counter}...`);
                } else {
                    return Promise.reject(reason);
                }
            });
